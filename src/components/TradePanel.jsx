...
export default function TradePanel({ token, user, setUser }) {
  ...
  const handleBuy = async (e) => {
    ...
    try {
      const res = await fetch(`${API_URL}/api/trade/buy`, {
        method: "POST",
        headers: {
      ...
      setMessage(`Куплено! Новый баланс: $${data.walletBalance.toFixed(2)}`)
